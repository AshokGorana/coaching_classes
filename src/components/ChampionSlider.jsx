  ...
  return (
    <div className="mt-5 grid grid-cols-2 gap-[12rem] px-24">
      ...
      <div className="">
        ...
        >
          <SwiperSlide>
            <img className="w-sm" src="./public/slide1.webp" alt="Slide 1" />
          </SwiperSlide>
          <SwiperSlide>
            <img className="w-sm" src="./public/slide2.webp" alt="Slide 2" />
          </SwiperSlide>
          <SwiperSlide>
            <img className="w-sm" src="./public/slide3.webp" alt="Slide 3" />
          </SwiperSlide>
        </Swiper>
      </div>
    </div>
